...
class ResNet(nn.Module):
	def __init__(self, residualBlock, layers, img_channels, num_classes):  # layers : list -> resBlock 몇 번 쓸지, ex. [3]
	...
	def _make_layer(self, residualBlock, num_residual_block, out_channels, stride):
		...
		for i in range(num_residual_block-1):
			layers.append(residualBlock(self.in_channels, out_channels)) # 256
